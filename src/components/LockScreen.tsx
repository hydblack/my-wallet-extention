  ...
  return (
    <div className="plasmo-flex plasmo-flex-col plasmo-items-center plasmo-justify-between plasmo-min-h-[500px] plasmo-bg-[#2d3142] plasmo-p-6">
      ...
      <div className="plasmo-text-center">
        ...
        <h1 className="plasmo-text-2xl plasmo-font-bold plasmo-text-[#c8f560]">MetaNodeWallet</h1>
        <p className="plasmo-mt-2 plasmo-text-sm plasmo-text-gray-400">安全、简单的 Web3 钱包</p>
      </div>
