...
export const MainDashboard: React.FC<MainDashboardProps> = ({ onLock, onExport }) => {
  const [accounts] = useState<Account[]>([
    { address: '0x1234...5678', name: 'Account 1', balance: '1.234 ETH', index: 0 },
    { address: '0xabcd...efgh', name: 'Account 2', balance: '0.567 ETH', index: 1 },
  ]);
